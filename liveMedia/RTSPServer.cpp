...
RTSPServer::RTSPServer(UsageEnvironment& env,
  ...
  : GenericMediaServer(env, ourSocket, ourPort, reclamationSeconds),
    ...
    fRegisterOrDeregisterRequestCounter(0), fAuthDB(authDatabase), fAllowStreamingRTPOverTCP(True), fPublicIP(NULL) {
}
...
::RTSPClientConnection(RTSPServer& ourServer, int clientSocket, struct sockaddr_in clientAddr)
  : GenericMediaServer::ClientConnection(ourServer, clientSocket, clientAddr),
	...
	// ASE to remove
//	printf( "new RTSPServer::RTSPClientConnection::RTSPClientConnection" );
...
//  printf( "YES !!!! DESCRIBE \r\n" );
  ...
  do {
	...
	// ASE to debug
//	printf( "RTSPServer::RTSPClientConnection::handleCmd_DESCRIBE authentication \r\n" );
	...
	// ASE to debug
//	printf( "RTSPServer::RTSPClientConnection::handleCmd_DESCRIBE Recherche d'un mediaServer %s \r\n", urlTotalSuffix );
    
    // Begin by looking up the "ServerMediaSession" object for the specified "urlTotalSuffix":
    session = fOurServer.lookupServerMediaSession(urlTotalSuffix);
    if (session == NULL) {
		// ASE to debug
//		printf( "RTSPServer::RTSPClientConnection::handleCmd_DESCRIBE Pas de mediaServer \r\n" );
	...
	// ASE to debug
//	printf( "RTSPServer::RTSPClientConnection::handleCmd_DESCRIBE Génération du SDP\r\n" );
...
void RTSPServer::RTSPClientConnection::handleRequestBytes(int newBytesRead) {
	...
	// ASE to remove
//	printf("--> RTSPServer::RTSPClientConnection::handleRequestBytes - Begin\r\n");
...
//		  printf("--> Receive SETUP Command\r\n");
	...
	if (clientSession != NULL) {
		// ASE to remove
//		printf("--> RTSPServer::RTSPClientConnection::handleRequestBytes - command SETUP\r\n");
