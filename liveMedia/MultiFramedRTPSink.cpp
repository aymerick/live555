...
Boolean MultiFramedRTPSink::continuePlaying() {
	// ASE to remove.
//	printf("MultiFramedRTPSink::continuePlaying()\r\n");
...
void MultiFramedRTPSink::buildAndSendPacket(Boolean isFirstPacket) {
  // ASE to remove
//  printf("MultiFramedRTPSink::buildAndSendPacket\r\n");
...
void MultiFramedRTPSink::packFrame() {
  ...
  // ASE to remove
//  printf("MultiFramedRTPSink::packFrame\r\n");
...
void MultiFramedRTPSink::ourHandleClosure(void* clientData) {
	...
	// ASE to remove
//	printf("MultiFramedRTPSink::ourHandleClosure\r\n");
